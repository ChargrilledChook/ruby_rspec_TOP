...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_ongoing) { described_class.new(8, '3') }
      # remove the 'x' before running this test
      it 'is not game over' do
        expect(game_ongoing).to_not be_game_over
      end
    end
  end
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        high = '69'
        valid = '7'
        allow(game_loop).to receive(:player_input).and_return(poo, high, valid)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 2-3' do
      subject(:game_three) { described_class.new(5, '8', 3) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
    ...
    context 'when count is 4 and over' do
      subject(:game_nine) { described_class.new(1, '8', 9) }
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        you_suck = "That was hard. It took you 9 guesses!\n"
        expect { game_nine.final_message }.to output(you_suck).to_stdout
      end
    end
  end
end
